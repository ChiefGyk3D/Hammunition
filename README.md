...
| Curated desktop menus (Xfce menu-spec + GNOME app-folders) | ✅ generated from category tags; the menu-spec layer applied cleanly on KDE Plasma on the field laptop (2026-09-12, by-eye check still open); COSMIC unmeasured — the Pop VM exists now, its desktop has not been looked at |

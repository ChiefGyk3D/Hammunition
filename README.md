...
| Package manifests | 🟡 **247**, up from 71 |
| …Debian Blend coverage | ✅ **152 of 152** — SCOPE.md's first 1.0 stage, complete |
| …parity coverage | 🟡 **105 of the 124 units that owe a manifest** — [every gap has a recorded reason](docs/reference/parity-coverage.md) |

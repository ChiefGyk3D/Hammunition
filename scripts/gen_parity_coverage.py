...
EXPLAINED: dict[str, str] = {
    ...
    "radiosonde_auto_rx": "REVIVE waiting on the venv backend, by design",
    ...
    "yaac": "Java jar; waits on launcher generation",
    "AntScope2": "vendor .deb, x86_64 only; waits on the binary backend",
    ...
    "PIAPRS": "QtTermTCP family — waits on the binary backend",
    "PITERM": "QtTermTCP — waits on the binary backend",
    "QTSOUND": "QtSoundModem — waits on the binary backend",

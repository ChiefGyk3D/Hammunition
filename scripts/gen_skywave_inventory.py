...
APT_TSV = SRC / "apt-debian-13.tsv"
APT_SID_TSV = SRC / "apt-debian-sid.tsv"
BLEND_TSV = SRC / "apt-blend-debian-13.tsv"
BLEND_SID_TSV = SRC / "apt-blend-debian-sid.tsv"
...
def render() -> str:
    ...
    add("")
    add("| Unit | Upstream we would use | Licence | State |")
    add("|---|---|---|---|")
    for unit, upstream, lic, state in UPSTREAMS:
        add(f"| {unit} | {upstream} | {lic} | {state} |")
    add("")

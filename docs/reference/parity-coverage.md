...
| `AntScope2` | CARRY | vendor .deb, x86_64 only; waits on the binary backend |
...
| `AntScope2` | CARRY | — *waiting, see above* |
...
| `gqrx` | CARRY | `gqrx-sdr` |
| `GRIDCALC` | RETIRE | — |
| `GridTracker2` | CARRY | — *waiting, see above* |

...
**Generated:** 2026-08-27, Debian 13  
**Kernel id→driver pairs read:** 7694  
**udev rule identifiers read:** 2763  
**LoRa mesh board definitions read:** 299  
**Identifiers that name a chip, not a device:** 1258

| Basis | Count |
|---|---:|
| `distribution_disabled` | 11 |
| `kernel_generic_driver` | 1167 |
| `shared_across_products` | 80 |
...
| `0403:8a98` | TIAO Multi-Protocol Adapter | `flashrom`, `openocd` | TUMPA, TUMPA Lite; http://www.diygadget.com/tiao-usb-multi-protocol-adapter-jtag-spi-i2c-serial.html |
| `0403:8a99` | — | `flashrom`, `openocd` | TUMPA, TUMPA Lite; http://www.tiaowiki.com/w/TIAO_USB_Multi_Protocol_Adapter_Lite_User's_Manual |
| `2687:fb01` | Base Station | `galileo`, `galileo-daemon` | console and not as a daemon.; run galileo as a daemon under the "galileo" account. |

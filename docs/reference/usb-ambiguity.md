...
|---|---|---|---|
| `16c0:05dc` | shared ID for use with libusb | `avrdude`, `libhamlib4t64`, `ola`, `qlcplus` | USBasp; VOTI USBasp AVR Programmer; for Anyma's uDMX devices and clones, and; udev rules for the anyma dmx device |
...
| `2c7c:0125` | EC25 LTE modem | `eg25-manager`, `modemmanager` | Default attributes values; ttyUSB3 (if #3): AT secondary port |
...
| `0403:8a98` | TIAO Multi-Protocol Adapter | `flashrom`, `openocd` | TIAO/DIYGADGET USB Multi-Protocol Adapter (TUMPA); TUMPA, TUMPA Lite |

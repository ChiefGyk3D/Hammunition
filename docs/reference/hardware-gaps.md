...
**Devices in catalog:** 21 — **6 with a confirmed identifier, 15 without**
...
**8 of 21 devices claim `supported`; 0 have been run here.** That gap is not a defect to be closed by relaxing either column. It is the honest state, and printing it is the point.

...
**Devices in catalog:** 21 — **10 fully characterised, 11 with something still unknown**

Of those 21, **17 carry at least one confirmed USB identifier of their own** and **7 have been run on hardware here** (D-027: two different claims).

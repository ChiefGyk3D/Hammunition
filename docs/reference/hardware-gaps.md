...
**Devices in catalog:** 21 — **7 with a confirmed identifier, 14 without**
...
**12 of 21 devices claim `supported`; 4 have been run here.** That gap is not a defect to be closed by relaxing either column. It is the honest state, and printing it is the point.

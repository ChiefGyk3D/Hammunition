...
**Devices in catalog:** 24 — **12 fully characterised, 12 with something still unknown**

Of those 24, **19 carry at least one confirmed USB identifier of their own** and **7 have been run on hardware here** (D-027: two different claims).
...
**18 of 24 devices claim `supported`; 7 have been run here.** That gap is not a defect to be closed by relaxing either column. It is the honest state, and printing it is the point.
